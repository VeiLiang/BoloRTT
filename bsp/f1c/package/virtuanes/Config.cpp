...
// 	CRegistryriteProfileInt   ( section.c_str(), "DoubleExecute",   general.bDoubleExecute );
// 	CRegistryriteProfileInt   ( section.c_str(), "StartupLauncher", general.bStartupLauncher );

// //	CRegistryriteProfileInt( section.c_str(), "WindowPosSave",	general.bWindowSave );
// 	CRegistryriteProfileInt   ( section.c_str(), "WindowZoom",	general.bWindowZoom );
// 	CRegistryriteProfileBinary( section.c_str(), "WindowPos",	(LPBYTE)&general.rcWindowPos, sizeof(RECT) );
// 	CRegistryriteProfileInt   ( section.c_str(), "ScreenZoom",	general.nScreenZoom );

// 	CRegistryriteProfileBinary( section.c_str(), "SearchDialogPos", (LPBYTE)&general.rcSearchDlgPos, sizeof(RECT) );

// 	CRegistryriteProfileBinary( section.c_str(), "PatternViewPos", (LPBYTE)&general.rcPatternViewPos, sizeof(RECT) );
// 	CRegistryriteProfileBinary( section.c_str(), "NameTableViewPos", (LPBYTE)&general.rcNameTableViewPos, sizeof(RECT) );
// 	CRegistryriteProfileBinary( section.c_str(), "PaletteViewPos", (LPBYTE)&general.rcPaletteViewPos, sizeof(RECT) );
// 	CRegistryriteProfileBinary( section.c_str(), "MemoryViewPos", (LPBYTE)&general.rcMemoryViewPos, sizeof(RECT) );

// 	CRegistryriteProfileBinary( section.c_str(), "BarcodePos", (LPBYTE)&general.rcBarcodePos, sizeof(RECT) );

// 	CRegistryriteProfileBinary( section.c_str(), "PaletteEditPos", (LPBYTE)&general.rcPaletteEditPos, sizeof(RECT) );

// 	CRegistryriteProfileInt   ( section.c_str(), "JoyAxisDisable", general.nJoyAxisDisable );
// 	CRegistryriteProfileBinary( section.c_str(), "JoyAxisSetting", (LPBYTE)general.JoyAxisSetting, 16*sizeof(WORD) );

// 	CRegistryriteProfileInt   ( section.c_str(), "NoJoystickID", general.bNoJoystickID );

// // Paths
// 	section = "Path";

// 	CRegistryriteProfileInt( section.c_str(), "RomPathUse",      path.bRomPath );
// 	CRegistryriteProfileInt( section.c_str(), "SavePathUse",     path.bSavePath );
// 	CRegistryriteProfileInt( section.c_str(), "StatePathUse",    path.bStatePath );
// 	CRegistryriteProfileInt( section.c_str(), "SnapshotPathUse", path.bSnapshotPath );
// 	CRegistryriteProfileInt( section.c_str(), "MoviePathUse",    path.bMoviePath );
// 	CRegistryriteProfileInt( section.c_str(), "WavePathUse",     path.bWavePath );
// 	CRegistryriteProfileInt( section.c_str(), "CheatPathUse",    path.bCheatPath );
// 	CRegistryriteProfileInt( section.c_str(), "IpsPathUse",      path.bIpsPath );

// 	CRegistryriteProfileString( section.c_str(), "RomPath",      path.szRomPath );
// 	CRegistryriteProfileString( section.c_str(), "SavePath",     path.szSavePath );
// 	CRegistryriteProfileString( section.c_str(), "StatePath",    path.szStatePath );
// 	CRegistryriteProfileString( section.c_str(), "SnapshotPath", path.szSnapshotPath );
// 	CRegistryriteProfileString( section.c_str(), "MoviePath",    path.szMoviePath );
// 	CRegistryriteProfileString( section.c_str(), "WavePath",     path.szWavePath );
// 	CRegistryriteProfileString( section.c_str(), "CheatPath",    path.szCheatPath );
// 	CRegistryriteProfileString( section.c_str(), "IpsPath",      path.szIpsPath );

// // Emulation
// 	section = "Emulation";

// 	CRegistryriteProfileInt( section.c_str(), "IllegalOp",     emulator.bIllegalOp );
// 	CRegistryriteProfileInt( section.c_str(), "AutoFrameSkip", emulator.bAutoFrameSkip );
// 	CRegistryriteProfileInt( section.c_str(), "Throttle",      emulator.bThrottle );
// 	CRegistryriteProfileInt( section.c_str(), "ThrottleFPS",   emulator.nThrottleFPS );
// 	CRegistryriteProfileInt( section.c_str(), "Background",    emulator.bBackground );
// 	CRegistryriteProfileInt( section.c_str(), "Priority",      emulator.nPriority );
// 	CRegistryriteProfileInt( section.c_str(), "FourPlayer",    emulator.bFourPlayer );
// 	CRegistryriteProfileInt( section.c_str(), "CrcCheck",      emulator.bCrcCheck );
// 	CRegistryriteProfileInt( section.c_str(), "DiskThrottle",  emulator.bDiskThrottle );
// 	CRegistryriteProfileInt( section.c_str(), "LoadFullscreen",emulator.bLoadFullscreen );
// 	CRegistryriteProfileInt( section.c_str(), "PNGsnapshot",   emulator.bPNGsnapshot );
// 	CRegistryriteProfileInt( section.c_str(), "AutoIPS",       emulator.bAutoIPS );

// // Graphic
// 	section = "Graphics";

// 	CRegistryriteProfileInt( section.c_str(), "Aspect",        graphics.bAspect );
// 	CRegistryriteProfileInt( section.c_str(), "SpriteMax",     graphics.bAllSprite );
// 	CRegistryriteProfileInt( section.c_str(), "AllLine",       graphics.bAllLine );
// 	CRegistryriteProfileInt( section.c_str(), "FPSDisp",       graphics.bFPSDisp );
// 	CRegistryriteProfileInt( section.c_str(), "TVFrameMode",   graphics.bTVFrame );
// 	CRegistryriteProfileInt( section.c_str(), "ScanlineMode",  graphics.bScanline );
// 	CRegistryriteProfileInt( section.c_str(), "ScanlineColor", graphics.nScanlineColor );
// 	CRegistryriteProfileInt( section.c_str(), "SyncDraw",      graphics.bSyncDraw );
// 	CRegistryriteProfileInt( section.c_str(), "MaxZoom",       graphics.bFitZoom );

// 	CRegistryriteProfileInt( section.c_str(), "LeftClip",      graphics.bLeftClip );

// 	CRegistryriteProfileInt( section.c_str(), "WindowVSync",   graphics.bWindowVSync );
// 	CRegistryriteProfileInt( section.c_str(), "SyncNoSleep",   graphics.bSyncNoSleep );

// 	CRegistryriteProfileInt( section.c_str(), "DiskAccessLamp",graphics.bDiskAccessLamp );

// 	CRegistryriteProfileInt( section.c_str(), "DoubleSize",    graphics.bDoubleSize );
// 	CRegistryriteProfileInt( section.c_str(), "SystemMemory",  graphics.bSystemMemory );
// 	CRegistryriteProfileInt( section.c_str(), "UseHEL",        graphics.bUseHEL );

// 	CRegistryriteProfileInt( section.c_str(), "NoSquareList",  graphics.bNoSquareList );

// 	CRegistryriteProfileInt( section.c_str(), "GraphicsFilter",graphics.nGraphicsFilter );

// 	CRegistryriteProfileInt( section.c_str(), "DisplayWidth",  graphics.dwDisplayWidth );
// 	CRegistryriteProfileInt( section.c_str(), "DisplayHeight", graphics.dwDisplayHeight );
// 	CRegistryriteProfileInt( section.c_str(), "DisplayDepth",  graphics.dwDisplayDepth );
// 	CRegistryriteProfileInt( section.c_str(), "DisplayRate",   graphics.dwDisplayRate );

// 	CRegistryriteProfileInt( section.c_str(), "PaletteUse",   graphics.bPaletteFile );
// 	CRegistryriteProfileString( section.c_str(), "PaletteFile", graphics.szPaletteFile );

// // Sound
// 	section = "Sound";

// 	CRegistryriteProfileInt( section.c_str(), "Enable",       sound.bEnable );

// 	CRegistryriteProfileInt( section.c_str(), "DisableVolumeEffect", sound.bDisableVolumeEffect );
// 	CRegistryriteProfileInt( section.c_str(), "ExtraSoundEnable",    sound.bExtraSoundEnable );

// 	CRegistryriteProfileInt( section.c_str(), "SamplingRate", sound.nRate );
// 	CRegistryriteProfileInt( section.c_str(), "SamplingBits", sound.nBits );
// 	CRegistryriteProfileInt( section.c_str(), "BufferSize",   sound.nBufferSize );
// 	CRegistryriteProfileInt( section.c_str(), "FilterType",   sound.nFilterType );

// 	CRegistryriteProfileBinary( section.c_str(), "Volume", (LPBYTE)sound.nVolume, sizeof(sound.nVolume) );

// // ShortCut
// 	section = "ShortCut";
// 	for( i = 0; i < sizeof(shortcut.nShortCut)/(16*sizeof(WORD)); i++ ) {
// 		sprintf( keys, "TBL%02d", i );
// 		CRegistryriteProfileBinary( section.c_str(), keys, (LPBYTE)&shortcut.nShortCut[i*16], 16*sizeof(WORD) );
// 	}

// // Controllers
// 	for( i = 0; i < 4; i++ ) {
// 		sprintf( keys, "Controller %01d", i+1 );
// 		CRegistryriteProfileBinary( keys, "Keys", (LPBYTE)controller.nButton[i], 64*sizeof(WORD) );
// 		CRegistryriteProfileBinary( keys, "Rapid", (LPBYTE)controller.nRapid[i], 2*sizeof(WORD) );
// 	}

// // ExControllers
// 	section = "Crazy Climber";
// 	CRegistryriteProfileBinary( section.c_str(), "Keys", (LPBYTE)controller.nExButton[0], 64*sizeof(WORD) );
// 	section = "Family Trainer";
// 	CRegistryriteProfileBinary( section.c_str(), "Keys", (LPBYTE)controller.nExButton[1], 64*sizeof(WORD) );
// 	section = "Exciting Boxing";
// 	CRegistryriteProfileBinary( section.c_str(), "Keys", (LPBYTE)controller.nExButton[2], 64*sizeof(WORD) );
// 	section = "Mahjang";
// 	CRegistryriteProfileBinary( section.c_str(), "Keys", (LPBYTE)controller.nExButton[3], 64*sizeof(WORD) );

// // NSF Contoller
// 	section = "NSF controller";
// 	CRegistryriteProfileBinary( section.c_str(), "Keys", (LPBYTE)controller.nNsfButton, 64*sizeof(WORD) );

// // VS-Unisystem
// 	section = "VS-Unisystem";
// 	CRegistryriteProfileBinary( section.c_str(), "Keys", (LPBYTE)controller.nVSUnisystem, 64*sizeof(WORD) );

// // Movie
// 	section = "Movie";
// 	CRegistryriteProfileBinary( section.c_str(), "UsePlayer", (LPBYTE)movie.bUsePlayer, sizeof(movie.bUsePlayer) );
// 	CRegistryriteProfileInt( section.c_str(), "ResetRec", movie.bResetRec );
// 	CRegistryriteProfileInt( section.c_str(), "Rerecord", movie.bRerecord );
// 	CRegistryriteProfileInt( section.c_str(), "LoopPlay", movie.bLoopPlay );
// 	CRegistryriteProfileInt( section.c_str(), "PadDisplay", movie.bPadDisplay );
// 	CRegistryriteProfileInt( section.c_str(), "TimeDisplay", movie.bTimeDisplay );

// // Launcher
// 	section = "Launcher";

// 	CRegistryriteProfileBinary( section.c_str(), "WindowPos", (LPBYTE)&launcher.rcWindowPos, sizeof(RECT) );

// 	CRegistryriteProfileBinary( section.c_str(), "ColumnView",  (LPBYTE)launcher.bHeaderView,  sizeof(launcher.bHeaderView) );
// 	CRegistryriteProfileBinary( section.c_str(), "ColumnOrder", (LPBYTE)launcher.nHeaderOrder, sizeof(launcher.nHeaderOrder) );
// 	CRegistryriteProfileBinary( section.c_str(), "ColumnWidth", (LPBYTE)launcher.nHeaderWidth, sizeof(launcher.nHeaderWidth) );

// 	CRegistryriteProfileInt( section.c_str(), "ListSelect", launcher.nListSelect );

// 	CRegistryriteProfileInt( section.c_str(), "SortDir",  launcher.bSortDir );
// 	CRegistryriteProfileInt( section.c_str(), "SortType", launcher.nSortType );

// 	CRegistryriteProfileBinary( section.c_str(), "FolderUse", (LPBYTE)launcher.bFolderUse, sizeof(launcher.bFolderUse) );

// 	for( i = 0; i < 16; i++ ) {
// 		sprintf( keys, "Folder%02d", i );
// 		CRegistryriteProfileString( section.c_str(), keys, launcher.szFolder[i] );
// 	}

// 	CRegistryriteProfileString( section.c_str(), "LastSelect", launcher.szLastSelect );

// 	CRegistryriteProfileInt( section.c_str(), "ActivePause",  launcher.bActivePause );

// // NetPlay
// 	section = "Netplay";

// 	CRegistryriteProfileBinary( section.c_str(), "ChatPos", (LPBYTE)&netplay.rcChatPos, sizeof(RECT) );

// 	CRegistryriteProfileString( section.c_str(), "NickName", netplay.szNick );

// 	CRegistryriteProfileInt( section.c_str(), "RecnetPortNum", netplay.nRecentPort );
// 	for( i = 0; i < 16; i++ ) {
// 		sprintf( keys, "RecentPort%02d", i );
// 		CRegistryriteProfileString( section.c_str(), keys, netplay.szRecentPort[i] );
// 	}
// 	CRegistryriteProfileInt( section.c_str(), "RecnetHostNum", netplay.nRecentHost );
// 	for( i = 0; i < 16; i++ ) {
// 		sprintf( keys, "RecentHost%02d", i );
// 		CRegistryriteProfileString( section.c_str(), keys, netplay.szRecentHost[i] );
// 	}
}
extern "C"
{
...
BOOL	CConfig::ButtonCheck( INT nNo, INT nID )
{
	...
	{
		case 0:
			ret = input_key_up_press();
			break;
		case 1:
			ret = input_key_do_press();
			break;
		case 2:
			ret = input_key_lf_press();
			break;
		case 3:
			ret = input_key_rg_press();
			break;
		case 4:
			ret = input_key_sa_press();
			break;
		case 5:
			ret = input_key_sb_press();
			break;
		case 6:
			ret = input_key_aa_press();
			break;
		case 7:
			ret = input_key_bb_press();
			break;
		case 8:
			ret = input_key_se_press();
			break;
		case 9:
			ret = input_key_st_press();
			break;
...
void	CGameOption::Save( LPCSTR name, DWORD crc )
{
	...
	// CHAR	szSection[256];
	// sprintf( szSection, "%08X", crc );
	// CRegistryriteProfileString( szSection, "Title", name );
	// CRegistryriteProfileInt( szSection, "RenderMethod",    nRenderMethod );
	// CRegistryriteProfileInt( szSection, "IRQtype",         nIRQtype );
	// CRegistryriteProfileInt( szSection, "FrameIRQ",        (INT)bFrameIRQ );
	// CRegistryriteProfileInt( szSection, "VideoMode",       (INT)bVideoMode );
}
...
void	CGameOption::Load( DWORD gid, DWORD mid )
{
	...
	// CHAR	szSection[256];
	// sprintf( szSection, "%08X%08X", gid, mid );
	// nRenderMethod =       CRegistry::GetProfileInt( szSection, "RenderMethod",    defRenderMethod );
	// nIRQtype      =       CRegistry::GetProfileInt( szSection, "IRQtype",         defIRQtype );
	// bFrameIRQ     = (BOOL)CRegistry::GetProfileInt( szSection, "FrameIRQ",        defFrameIRQ );
}
